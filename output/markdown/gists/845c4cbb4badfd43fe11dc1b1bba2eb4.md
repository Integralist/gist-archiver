# [Golang unzip(.zip) and untar(.tar.gz) contents of archive to specified destination] #go #golang #unzip #chunk #tar #gz

## Golang unzip contents of zip archive to specified destination.go
